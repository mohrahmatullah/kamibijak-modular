    ...
    <section>
      <div class="row mx-0">
        <div class="col-12 px-0">
          ...
          <!-- START ZONA BANNER KB HOME LBT1 MOBILE 350X150 -->
          @foreach($banners as $b)
            @if($b->placement == 'kb-home-lbt1-mobile-350X150')
              <section class="py-3">
            ...
            @endif
          @endforeach
          <!-- END ZONA BANNER KB HOME LBT1 MOBILE 350X150 -->
          ...
          <div class="row mx-0">
            ...
            @foreach($post as $key => $p)           
              ...
              @if($key == 4)
                <!-- START ZONA BANNER KB HOME MR1 MOBILE 350X350 -->
                @foreach($banners as $b)
                  @if($b->placement == 'kb-home-mr1-mobile-350X350')
                  ...
                  @endif
                @endforeach
                <!-- END ZONA BANNER KB HOME MR1 MOBILE 350X350 -->
              @endif

              @if($key == 9)
                <!-- START ZONA BANNER KB HOME MR2 MOBILE 350X350 -->
                @foreach($banners as $b)
                  @if($b->placement == 'kb-home-mr2-mobile-350X350')
                    <section class="py-3 mx-1">
                      <div class="w-100 text-center">
                        @if($b->code == '')
                        <a href="{{ $b->link }}">
                  ...
                  @endif
                @endforeach
                <!-- END ZONA BANNER KB HOME MR2 MOBILE 350X350 -->
              @endif

              @if($key == 14)                
                <!-- START ZONA BANNER KB HOME MR3 MOBILE 350X350 -->
                @foreach($banners as $b)
                  @if($b->placement == 'kb-home-mr3-mobile-350X350')
                    <section class="py-3 mx-1">
                      <div class="w-100 text-center">
                        @if($b->code == '')
                        <a href="{{ $b->link }}">
                  ...
                  @endif
                @endforeach
                <!-- END ZONA BANNER KB HOME MR3 MOBILE 350X350 -->
              @endif

              @if($key == 19)
                <!-- START ZONA BANNER KB HOME MR4 MOBILE 350X350 -->
                @foreach($banners as $b)
                  @if($b->placement == 'kb-home-mr4-mobile-350X350')
                    <section class="py-3 mx-1">
                      <div class="w-100 text-center">
                        @if($b->code == '')
                        <a href="{{ $b->link }}">
                  ...
                  @endif
                @endforeach
                <!-- END ZONA BANNER KB HOME MR4 MOBILE 350X350 -->
              @endif
