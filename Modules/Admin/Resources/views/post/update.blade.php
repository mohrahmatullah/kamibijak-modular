...
@section('title', 'Admin | Post | Update')
@section('content')
...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-warning">
    <div class="box-header">
      <h3 class="box-title">Update Post &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="{{ route('admin.post_list') }}">Post List</a></h3>
  ...
  <div class="row">
    <div class="col-md-8">
      <div class="box box-solid">
        ...
        <div class="box-body">
          <input oninput="inputTitlePost()" type="text" maxlength="100" placeholder="Title" class="form-control" id="post_title" name="post_title" value="{{ $post->title }}">
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <!-- <input type="text" placeholder="Slug" name="post_slug" value="{{ $post->slug }}" class="form-control" readonly> -->
          @if(in_array('update-post_slug', $permissions_per_session))
            <input type="text" placeholder="Slug" name="post_slug" value="{{ $post->slug }}" id="post_slug" class="form-control">
            @if(!empty($errors->first('post_slug')))
            <p class="text-red"><i class="icon fa fa-ban"></i> {{ $errors->first('post_slug') }}</p>
            @endif
          @else
            <input type="text" placeholder="Slug" name="post_slug" value="{{ $post->slug }}" id="post_slug" class="form-control" readonly>
            @if(!empty($errors->first('post_slug')))
            <p class="text-red"><i class="icon fa fa-ban"></i> {{ $errors->first('post_slug') }}</p>
            @endif
          @endif
      ...
      <div class="box box-solid" style="display: none;">
        ...
        <div class="box-body">
          <input type="text" placeholder="Label" class="form-control" name="post_label" value="{{ $post->label }}">
        </div>
      </div>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <textarea id="text_editor_post_content" name="post_content" rows="10" cols="80">{{ $post->content }}</textarea>
            ...
            <div class="tab-content">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group mx-4">
                      ...
                      @php
                      $embedscript = substr($post->embed, 68, -77);
                      @endphp
                      <input type="text" id="yt_id" name="post_embed_script" placeholder="Embed Script" class="form-control" value="{{ $embedscript }}"/>
                    ...
                    <!-- <div class="form-group mx-4">
                      <label for="post_thumbnail">Thumbnail</label>
                        ...
                        <div class="thumbnail-picture text-center">
                          <div class="img-div"><img src="{{ get_image_url($post->thumbnail) }}" class="user-image" alt="" style="width: 30%;"/></div><br>
                          <div class="btn-div"><button type="button" class="btn btn-danger remove-cms-thumbnail-picture">Remove image</button></div>
                        </div>
                        <div class="no-thumbnail-picture text-center" style="display:none;">
                       ...
                       <input type="hidden" name="post_thumbnail" id="hf_cms_thumbnail_picture" value="{{ $post->thumbnail }}">
                    </div> -->
                    <div class="form-group mx-4">
                      <label for="post_cover">Cover</label>
                      <div class="row">
                        <div class="col-md-12">                          
                          <input type="hidden" name="post_cover" id="hf_cms_cover_picture" value="{{$post->cover}}">
                          @if(empty($post->cover))
                          ...
                          <div class="cover-picture text-center">
                            <div class="img-div"><img src="{{ get_image_url($post->cover) }}" class="user-image" alt="" style="width: 50%;"/></div><br>
                        ...
                        <!-- <div class="col-md-6">
                          ...
                          <input type="hidden" name="post_cover" id="hf_cms_cover_picture" value="">
                        </div>
                        <div class="col-md-6">
                          @if(!empty($post->cover))
                          <div class="cover-picture text-center">
                            <div class="img-div"><img src="{{ get_image_url($post->cover) }}" class="user-image" alt="" style="width: 30%;"/></div><br>
                            <div class="btn-div"><button type="button" class="btn btn-danger remove-cms-cover-picture">Remove image</button></div>
                          </div>
                          <div class="no-cover-picture text-center" style="display:none;">
                            <div class="img-div"><img src="{{ default_upload_sample_img_src() }}" class="user-image" alt=""/></div><br>
                          </div>
                          @else
                          <div class="cover-picture text-center" style="display:none;">
                    ...
                    <div class="form-group mx-4" style="display: none;">
                      <label for="inputWeight">Cover Label</label>
                        <input type="text" placeholder="Cover" name="post_cover_label" class="form-control">
                    </div>

                    <div class="form-group mx-4" style="display: none;">
                      <label>
                        <input type="checkbox" name="post_photo_only" class="flat-red" value="1" @if($post->is_photo_only == 1) checked @endif>
                        Photo Only
                      </label>
                    </div>
                 </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group mx-4" style="display: none;">
                      <label for="post_location">Location</label>
                        <input type="text" placeholder="Location" name="post_location" class="form-control" value="{{ $post->location }}">
                    </div>

                    <div class="form-group mx-4">
                      <label for="post_slug">Category</label>
                        ...
                        @if($category->count() > 0)
                          @foreach($category as $p)
                            <option value="{{ $p->id }}" @if(in_array($p->id, $selected_category)) selected @endif> {!! $p->name !!} </option>
                          @endforeach
                        @endif
                        </select>
                    ...
                    <div class="form-group mx-4">
                      <label for="post_location">Credit</label>
                      @php
                      $db = DB::table('post_credit_chain')->where('post',$post->id)->first();
                      @endphp
                      @if(empty($db))
                      ...
                      @else
                        ...
                        @if($user->count() > 0)
                          @foreach($user as $u)
                            <option value="{{ $u->id }}" @if(in_array($u->id, $selected_user)) selected @endif> {!! $u->fullname !!} </option>
                          @endforeach
                        @endif
                        </select>
                      @endif
              ...
              <div class="tab-features tab-pane" id="c">
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group mx-4" style="display: none;">
                      <label for="post_location">Listing Name</label>
                        <select name="post_listing[]" class="form-control select2" multiple="multiple" data-placeholder="Please Select Listing"
                        style="width: 100%;">
                        @if($listing->count() > 0)
                          @foreach($listing as $l)
                          <option value="{{ $l->id }}" @if(in_array($l->id, $selected_listing)) selected @endif>{{ $l->listing_name }}</option>
                          @endforeach
                        @endif
                       </select>
                    </div>
                    <div class="form-group mx-4" style="display: none;">
                      <label for="post_location">Source</label>
                        <input type="text" placeholder="Location" name="post_sources" class="form-control" value="{{ $post->sources }}">
                    </div>
                    <div class="form-group mx-4">
                      <label for="post_location">Gallery</label>
                        ...
                        @if($gallery->count() > 0)
                          ...
                          <option value="{{ $g->id }}" @if($post->gallery) selected @endif>{{ $g->name }}</option>
                          @endforeach
                        @endif
                      </select>
                    </div>
                    <div class="form-group mx-4">
                      <label for="post_location">Tag</label>
                      <div class="input-group input-group-sm">
                        <select name="post_tag[]" class="form-control select2" multiple="multiple" data-placeholder="Please Select Tag"
                        style="width: 100%;">
                          @if($tag->count() > 0)
                            @foreach($tag as $t)
                    ...
                    <div class="form-group mx-4" style="display: none;">
                      <label for="post_location">Microsite</label>
                        ...
                        @if($microsite->count() > 0)
                          ...
                          <option value="{{ $m->id }}" @if($post->microsite) selected @endif>{{ $m->name }}</option>
                          @endforeach
                        @endif
                      </select>
                    </div>
                    <!-- <div class="form-group mx-4">
                      ...
                      <select name="post_status" class="form-control select2" style="width: 100%;">
                        ...
                        <option value="2" @if($post->status == 2) selected @endif>Editor</option>
                        <option value="3" @if($post->status == 3) selected @endif>Schedule</option>
                        <option value="4" @if($post->status == 4) selected @endif>Published</option>
                      </select>
                    </div> -->
                    ...
                    <div class="form-group mx-4">
                      <div id="row_dim">
                          ...
                          <input type="text" name="post_published_schedule" class="form-control pull-right" id="datetimepicker12" @if(!empty($published_schedule)) value="{{ $published_schedule->published }}" @endif>
                      </div>
                      <!-- <div id="row_published">
                          <label for="post_date_published">Date Published</label>
                          <input type="text" name="post_date_published" class="form-control pull-right" id="datepublished" value="{{ $post->published }}">
                      </div> -->
                    </div>
                    ...
                    <div class="form-group mx-4">
                      <div class="row">
                        <div class="col-md-4 col-lg-4 col-xs-4">
                          <label>
                          <input type="checkbox" name="post_featured" class="flat-red"  value="1" @if($post->featured == 1) checked @endif>
                          Featured
                        </label>
                        </div>
                         <div class="col-md-8 col-lg-8 col-xs-8 text-left">                         
                        <label style="display: none;">
                          <input type="checkbox" name="post_editor_pick" class="flat-red"  value="1" @if($post->editor_pick == 1) checked @endif>
                          Editor Pick
                        </label>
                        </div>                        
                      </div>                    
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <select name="post_type" class="form-control select2" style="width: 100%;">            
            <option value="Video" @if($post->type_post == 'Video' ) selected @endif>Video</option>
            <option value="Article" @if($post->type_post == 'Article') selected @endif>Article</option>
          </select>
        </div>
      </div>
          ...
          <div class="box-body">
                <div class="form-group mx-4">
                  ...
                  <select name="post_schema" class="form-control select2" style="width: 100%;">
                    <option value="0" @if($post->seo_schema == 0) selected @endif>Schema</option>
                    <option value="CreativeWork" @if($post->seo_schema == 'CreativeWork') selected @endif>CreativeWork</option>
                    <option value="Article" @if($post->seo_schema == 'Article') selected @endif>Article</option>
                    <option value="Video" @if($post->seo_schema == 'Video') selected @endif>Video</option>
                    <option value="BlogPosting" @if($post->seo_schema == 'BlogPosting') selected @endif>BlogPosting</option>
                    <option value="TechArticle" @if($post->seo_schema == 'TechArticle') selected @endif>TechArticle</option>
                    <option value="Report" @if($post->seo_schema == 'Report') selected @endif>Report</option>
                    <option value="Review" @if($post->seo_schema == 'Review') selected @endif>Review</option>
                  </select>
                </div>

                <div class="form-group mx-4">
                  <label for="post_meta_title">Meta Title</label>                
                    <input type="text" maxlength="90" placeholder="Meta Title" name="post_meta_title" class="form-control" value="{{ $post->seo_title }}">
                ...
                <div class="form-group mx-4">
                  <label for="post_meta_description">Meta Description</label>
                    <textarea name="post_meta_description" placeholder="Meta Description" class="form-control">{{ $post->seo_description }}</textarea>
                ...
                <div class="form-group mx-4">
                  <label for="post_meta_keywords">Meta Keywords</label>
                    <input type="text" placeholder="Meta Keywords" name="post_meta_keywords" class="form-control" value="{{ $post->seo_keywords }}">
                </div>

                <div class="form-group mx-4" style="display: none;">
                  <label for="post_ganalytics_group">GAnalytics Group</label>
                    <input type="text" placeholder="GAnalytics Group" name="post_ganalytics_group" class="form-control" value="{{ $post->ga_group }}">                
                </div>
          </div>
      </div>
          ...
          <div class="box-body">
                  <div class="form-group mx-4">
                    <label for="post_score"> Score</label>
                      <input type="text" placeholder="Score" name="post_score" class="form-control" value="{{ $post->review_score }}">
                  </div>

                  <div class="form-group mx-4">
                    <label for="post_review_pros"> Reviews Pros</label>
                    <textarea name="post_review_pros" placeholder="Reviews Pros" class="form-control">{{ $post->review_pros }}</textarea>
                  </div>

                  <div class="form-group mx-4">
                    <label for="post_review_cons"> Reviews Cons</label>
                    <textarea name="post_review_cons" placeholder="Reviews Cons" class="form-control">{{ $post->review_cons }}</textarea>
                  </div>

                  <div class="form-group mx-4">
                    <label for="post_summary"> Summaary</label>
                    <textarea name="post_summary" placeholder="Summary" class="form-control">{{ $post->review_summary }}</textarea>
                  </div>
          </div>
      </div>
      ...
      <div class="modal-body">
        <div class="custom-model-row">
          <div class="custom-input-group">
            ...
            <div class="custom-input-element"><input oninput="inputName()" type="text" placeholder="Name" id="inputTagName" name="inputTagName" class="form-control"></div>
          </div>
          <div class="custom-input-group">
            <div class="custom-input-label"><label for="inputTagSlug">Slug</label></div>
            <div class="custom-input-element"><input type="text" placeholder="Slug" id="inputTagSlug" name="inputTagSlug" class="form-control" readonly>
            </div>
          </div>
          <div class="custom-input-group">
