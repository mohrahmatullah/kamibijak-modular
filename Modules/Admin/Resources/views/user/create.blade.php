...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-warning">
    <div class="box-header">
      <h3 class="box-title">Add New User &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="{{ route('admin.user_list') }}">User List</a></h3>
  ...
  <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
              <div class="box box-solid">
                ...
                <div class="box-body">
                  <input type="text" placeholder="Username" class="form-control" id="user_name" name="name">
                </div>
              </div>
              <div class="box box-solid">
                <div class="box-header with-border">
                ...
                <div class="box-body">
                  <input type="text" placeholder="Fullname" class="form-control" id="user_fullname" name="fullname">
                </div>
              </div>
              <div class="box box-solid">
                <div class="box-header with-border">
                ...
                <div class="box-body">
                  <input type="text" placeholder="Email" class="form-control" id="user_email" name="email">
                </div>
              </div> 
              <div class="box box-solid">
                <div class="box-body">
                  <div class="form-group mx-4">
                        <label>
                          <input type="checkbox" name="iscontributor" class="flat-red" value="1">
                          Is Contributor
                        </label>
                    </div>
                </div>
            ...
            <div class="col-md-6">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body">
                  <input type="text" placeholder="Website" class="form-control" id="user_website" name="website">
                </div>
              </div>
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <div class="col-md-4">
                      ...
                      <div class="checkbox">
                        <label for="perm-{{ $per->name }}" title="{{ $per->description }}">
                          <input type="checkbox" class="prm-All{{ $cls }}" id="perm-{{ $per->name }}" name="perms[{{ $per->name }}]" value="{{ $per->name }}">
                          {{ $per->label }}
                        </label>
                      </div>
                      @endforeach
            ...
            <div class="box-body">
                  <div class="form-group mx-4">
                    <label for="user_avatar">Avatar</label>
                       ...
                       <input type="hidden" name="user_avatar" id="hf_cms_useravatar_picture" value="">
                  </div>
                  ...
                  <div class="form-group mx-4">
                    <label for="post_meta_title">Background</label>                
                      <div class="backgrounduser-picture text-center" style="display:none;">
                       ...
                       <input type="hidden" name="user_background" id="hf_cms_backgrounduser_picture" value="">
                  </div>
      ...
      <div class="box box-warning">
            ...
            <div class="box-body">
                    ...
                    <div class="form-group mx-4">
                      ...
                      <input type="text" placeholder="Score" name="instagram" class="form-control">
                    </div>

                    <div class="form-group mx-4">
                      <label for="post_review_cons"><i class="fa fa-linkedin"></i> Linkendln</label>
                      <input type="text" placeholder="Linkendln" name="linkedin" class="form-control">
                    </div>

                    <div class="form-group mx-4">
                      <label for="post_summary"><i class="fa fa-pinterest-square"></i> Pinterest</label>
                      <input type="text" placeholder="Pinterest" name="pinterest" class="form-control">
                    </div>
    ...
    <input type="hidden" name="hf_user_type" id="hf_user_type" value="add_user">
</form>
<!-- /Main Content -->
@endsection